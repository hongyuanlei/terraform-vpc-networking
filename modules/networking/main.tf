...
resource "aws_subnet" "public_subnet" {
  ...
  tags = {
    Name        = "${var.namespace}-${element(var.availability_zones, count.index)}-public-subnet"
    Environment = var.environment
  }
}
...
resource "aws_subnet" "private_subnet" {
  ...
  tags = {
    Name        = "${var.namespace}-${element(var.availability_zones, count.index)}-private-subnet"
    Environment = var.environment
  }
}
